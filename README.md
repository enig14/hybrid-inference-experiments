...
* **사용 모델:** YOLOv11m | **선정 이유**: 초기에는 특정 연구 가설보다 실험 가능한 YOLO 계열 모델로 시작했습니다. 이후 진행 과정에서 YOLOv11m이 Jetson Orin NX에서 DLA 제약, hybrid 분할 실행, PTQ 정확도 문제를 함께 관찰할 수 있는 사례가 되었습니다.
## 💡 목표
