...
본 단계에서는 하이브리드 분할 추론이 유의미한 성능 향상을 제공하는지를 판단하기보다는, 실험을 구성하고 진행하는 과정에서 드러난 가속기 할당 제약과 실행 오버헤드를 정리하는 데 집중합니다.

성능 향상 여부에 대한 판단은 가속기 지정과 실행 경로를 명확히 통제할 수 있는 환경에서의 추가 실험을 통해 다루고자 합니다.
